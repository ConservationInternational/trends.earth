...
class DlgDownloadLPKS(DlgCalculateBase, Ui_DlgDownload):
    def __init__(self, parent=None):
        """Constructor."""
        super(DlgDownloadLPKS, self).__init__(parent)
    ...
    def tab_changed(self):
        super(DlgDownloadLPKS, self).tab_changed()
    ...
    def firstShow(self):
        super(DlgDownloadLPKS, self).firstShow()
        # Don't show the time selector for now
        # self.TabBox.removeTab(1)

    def showEvent(self, event):
        super(DlgDownloadLPKS, self).showEvent(event)
    ...
    def btn_calculate(self):
        ...
        # as well.
        ret = super(DlgDownloadLPKS, self).btn_calculate()
        if not ret:
            return
