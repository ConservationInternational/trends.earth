...
needs to be installed on the computer (Note: QGIS version 3.0.0 is not currently supported). QGIS can be downloaded from: 
http://www.qgis.org/en/site/forusers/download.html. Once the installer is 
