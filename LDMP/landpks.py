...
DlgLandPKSDownloadUi, _ = uic.loadUiType(str(Path(__file__).parent / "gui/DlgLandPKSDownload.ui"))
...
class DlgLandPKSDownload(calculate.DlgCalculateBase, DlgLandPKSDownloadUi):
    ...
    def btn_calculate(self):
        ...
        for dataset in selected_datasets:
            ...
            if resp:
                ...
                main_msg = "Error"
                description = (
                    "Unable to submit download request to LandPKS.")
            self.mb.pushMessage(
                self.tr(main_msg),
                self.tr(description),
                level=0,
