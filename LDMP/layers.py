...
style_text_dict = {
    # Shared
    'nodata':
    tr_layers.tr(u'No data'),

    # Productivity trajectory
    'prod_traj_trend_title':
    tr_layers.tr(
        u'Productivity trajectory ({year_initial} to {year_final}, NDVI x 10000 / yr)'
    ),
    'prod_traj_signif_title':
    tr_layers.tr(
        u'Productivity trajectory degradation ({year_initial} to {year_final})'
    ),
    'prod_traj_signif_dec_95':
    tr_layers.tr(u'Degradation (significant decrease, p < .05)'),
    'prod_traj_signif_zero':
    tr_layers.tr(u'Stable (no significant change)'),
    'prod_traj_signif_inc_95':
    tr_layers.tr(u'Improvement (significant increase, p < .05)'),

    # Productivity performance
    'prod_perf_deg_title':
    tr_layers.tr(
        u'Productivity performance degradation ({year_initial} to {year_final})'
    ),
    'prod_perf_deg_potential_deg':
    tr_layers.tr(u'Degradation'),
    'prod_perf_deg_not_potential_deg':
    tr_layers.tr(u'Not degradation'),
    'prod_perf_ratio_title':
    tr_layers.
    tr(u'Productivity performance ({year_initial} to {year_final}, ratio)'),
    'prod_perf_units_title':
    tr_layers.tr(u'Productivity performance ({year_initial}, units)'),

    # Productivity state
    'prod_state_change_title':
    tr_layers.tr(
        u'Productivity state degradation ({year_bl_start}-{year_bl_end} vs {year_tg_start}-{year_tg_end})'
    ),
    'prod_state_change_potential_deg':
    tr_layers.tr(u'Degradation'),
    'prod_state_change_stable':
    tr_layers.tr(u'Stable'),
    'prod_state_change_potential_improvement':
    tr_layers.tr(u'Improvement'),
    'prod_state_classes_title':
    tr_layers.tr(u'Productivity state classes ({year_initial}-{year_final})'),

    # Productivity progress comparison (not the real progress taking into
    # account magnitude)
    'prod_deg_comp_title':
    tr_layers.tr(
        u'Productivity degradation comparison ({baseline_year_initial}-{baseline_year_final} vs {progress_year_initial}-{progress_year_final})'
    ),
    'prod_deg_comp_deg':
    tr_layers.tr(u'Degradation'),
    'prod_deg_comp_stable':
    tr_layers.tr(u'Stable'),
    'prod_deg_comp_imp':
    tr_layers.tr(u'Improvement'),
    ...
    # Land cover
    'lc_deg_title':
    tr_layers.tr(u'Land cover degradation ({year_initial} to {year_final})'),
    'lc_deg_deg':
    tr_layers.tr(u'Degradation'),
    'lc_deg_stable':
    tr_layers.tr(u'Stable'),
    ...
    tr_layers.tr(u'Improvement'),
    'lc_7class_title':
    tr_layers.tr(u'Land cover ({year}, 7 class)'),
    'lc_esa_title':
    tr_layers.tr(u'Land cover ({year}, ESA CCI classes)'),
    'lc_7class_mode_title':
    tr_layers.tr(u'Land cover mode ({year_initial}-{year_final}, 7 class)'),
    'lc_esa_mode_title':
    tr_layers.
    tr(u'Land cover mode ({year_initial}-{year_final}, ESA CCI classes)'),
    'lc_class_nodata':
    tr_layers.tr(u'-32768 - No data'),
    'lc_class_forest':
    tr_layers.tr(u'1 - Tree-covered'),
    'lc_class_grassland':
    tr_layers.tr(u'2 - Grassland'),
    'lc_class_cropland':
    tr_layers.tr(u'3 - Cropland'),
    'lc_class_wetland':
    tr_layers.tr(u'4 - Wetland'),
    'lc_class_artificial':
    tr_layers.tr(u'5 - Artificial'),
    'lc_class_bare':
    tr_layers.tr(u'6 - Other land'),
    'lc_class_water':
    tr_layers.tr(u'7 - Water body'),
    ...
    tr_layers.tr(u'No data'),
    'Tree-covered':
    tr_layers.tr(u'Tree-covered'),
    'Grassland':
    tr_layers.tr(u'Grassland'),
    'Cropland':
    tr_layers.tr(u'Cropland'),
    'Wetland':
    tr_layers.tr(u'Wetland'),
    'Artificial':
    tr_layers.tr(u'Artificial'),
    'Other land':
    tr_layers.tr(u'Other land'),
    'Water body':
    tr_layers.tr(u'Water body'),
    'lc_tr_title':
    tr_layers.tr(u'Land cover (transitions, {year_initial} to {year_final})'),
    'lc_tr_nochange':
    tr_layers.tr(u'No change'),
    'lc_tr_forest_loss':
    tr_layers.tr(u'Tree-covered loss'),
    'lc_tr_grassland_loss':
    tr_layers.tr(u'Grassland loss'),
    'lc_tr_cropland_loss':
    tr_layers.tr(u'Cropland loss'),
    'lc_tr_wetland_loss':
    tr_layers.tr(u'Wetland loss'),
    'lc_tr_artificial_loss':
    tr_layers.tr(u'Artificial loss'),
    'lc_tr_bare_loss':
    tr_layers.tr(u'Other land loss'),
    'lc_tr_water_loss':
    tr_layers.tr(u'Water body loss'),

    # Soil organic carbon
    'soc_title':
    tr_layers.tr(u'Soil organic carbon ({year}, tons / ha)'),
    'soc_deg_title':
    tr_layers.
    tr(u'Soil organic carbon degradation ({year_initial} to {year_final})'),
    'soc_deg_deg':
    tr_layers.tr(u'Degradation'),
    'soc_deg_stable':
    tr_layers.tr(u'Stable'),
    ...
    'sdg_prod_combined_title':
    tr_layers.
    tr(u'Land productivity (Trends.Earth, {year_initial}-{year_final})'),
    'sdg_prod_combined_declining':
    tr_layers.tr(u'Declining'),
    'sdg_prod_combined_earlysigns':
    tr_layers.tr(u'Early signs of decline'),
    'sdg_prod_combined_stabbutstress':
    tr_layers.tr(u'Stable but stressed'),
    'sdg_prod_combined_stab':
    tr_layers.tr(u'Stable'),
    'sdg_prod_combined_imp':
    tr_layers.tr(u'Increasing'),

    # LPD
    'lpd_title':
    tr_layers.
    tr(u'Land productivity dynamics (LPD, {year_initial}-{year_final})'),
    'lpd_declining':
    tr_layers.tr(u'Declining'),
    'lpd_earlysigns':
    tr_layers.tr(u'Moderate decline'),
    'lpd_stabbutstress':
    tr_layers.tr(u'Stressed'),
    'lpd_stab':
    tr_layers.tr(u'Stable'),
    'lpd_imp':
    tr_layers.tr(u'Increasing'),
    ...
    'combined_sdg_title':
    tr_layers.tr(u'SDG 15.3.1 Indicator ({year_initial}-{year_final})'),
    'combined_sdg_deg_deg':
    tr_layers.tr(u'Degradation'),
    'combined_sdg_deg_stable':
    tr_layers.tr(u'Stable'),
    'combined_sdg_deg_imp':
    tr_layers.tr(u'Improvement'),
    'sdg_status_title':
    tr_layers.tr(
        u'SDG 15.3.1 Indicator ({baseline_year_initial}-{baseline_year_final} updated with {progress_year_initial}-{progress_year_final})'
    ),
    'sdg_status_deg':
    tr_layers.tr(u'Degradation'),
    'sdg_status_stable':
    ...
    'sdg_progress_title':
    tr_layers.tr(
        u'SDG 15.3.1 Progress ({baseline_year_initial}-{baseline_year_final} vs {progress_year_initial}-{progress_year_final})'
    ),

    # Forest loss
    'f_loss_hansen_title':
    tr_layers.tr(u'Forest loss ({year_initial} to {year_final})'),
    'f_loss_hansen_water':
    tr_layers.tr(u'Water'),
    'f_loss_hansen_nonforest':
    tr_layers.tr(u'Non-forest'),
    'f_loss_hansen_noloss':
    tr_layers.tr(u'Forest (no loss)'),
    'f_loss_hansen_year_start':
    tr_layers.tr(u'Forest loss ({year_initial})'),
    'f_loss_hansen_year_end':
    tr_layers.tr(u'Forest loss ({year_final})'),

    # Total carbon
    'tc_title':
    tr_layers.tr(u'Total carbon ({year_initial}, tonnes per ha x 10)'),

    # Root shoot ratio (below to above ground carbon in woody biomass)
    'root_shoot_title':
    tr_layers.tr(u'Root/shoot ratio (x 100)'),

    # Urban area series
    'urban_series_title':
    tr_layers.tr(u'Urban area change'),
    'urban_series_water':
    tr_layers.tr(u'Water'),
    'urban_series_built_up_by_2000':
    tr_layers.tr(u'Built-up by 2000'),
    'urban_series_built_up_by_2005':
    tr_layers.tr(u'Built-up by 2005'),
    'urban_series_built_up_by_2010':
    tr_layers.tr(u'Built-up by 2010'),
    'urban_series_built_up_by_2015':
    tr_layers.tr(u'Built-up by 2015'),

    # Urban area
    'urban_title':
    tr_layers.tr(u'Urban area {year}'),
    'urban_urban':
    tr_layers.tr(u'Urban'),
    'urban_suburban':
    tr_layers.tr(u'Suburban'),
    'urban_built_up_rural':
    tr_layers.tr(u'Built-up rural'),
    'urban_fringe_open_space':
    tr_layers.tr(u'Open space (fringe)'),
    'urban_captured_open_space':
    tr_layers.tr(u'Open space (captured)'),
    'urban_rural_open_space':
    tr_layers.tr(u'Open space (rural)'),
    'urban_fringe_open_space_water':
    tr_layers.tr(u'Open space (fringe, water)'),
    'urban_captured_open_space_water':
    tr_layers.tr(u'Open space (captured, water)'),
    'urban_rural_open_space_water':
    tr_layers.tr(u'Open space (rural, water)'),

    # Population titles
    'population_title':
    tr_layers.tr(u'Population ({year})'),
    'population_number_of_people':
    tr_layers.tr(u'Population ({type}, {year})'),
    'population_density_title':
    ...
    'spi_title':
    tr_layers.tr(
        u'Standardized Precipitation Index (SPI, {year}, {lag} month lag, * 1000)'
    ),
    'spi_at_maximum_drought_title':
    tr_layers.tr(
        u'SPI at maximum drought during {year_initial}-{year_final} ({lag} month lag, * 1000)'
    ),
    'jrc_drought_vulnerability_title':
    tr_layers.tr(u'Drought Vulnerability (JRC, {year}, * 1000)'),
    'spi_extreme_drought':
    tr_layers.tr(u'Extreme drought'),
    'spi_severe_drought':
    tr_layers.tr(u'Severe drought'),
    'spi_moderate_drought':
    tr_layers.tr(u'Moderate drought'),
    'spi_mild_drought':
    tr_layers.tr(u'Mild drought'),
    'spi_normal':
    tr_layers.tr(u'Normal'),
    'spi_mild_wet':
    tr_layers.tr(u'Mildly wet'),
    'spi_moderate_wet':
    tr_layers.tr(u'Moderately wet'),
    'spi_severe_wet':
    tr_layers.tr(u'Severely wet'),
    'spi_extreme_wet':
    tr_layers.tr(u'Extremely wet'),
    ...
    # Global Zoning
    'agro_eco_zones':
    tr_layers.tr('Agro Ecological Zones V3.0'),
    'climatic_zones':
    tr_layers.tr('Climatic Zones'),
    ...
    # Evapotranspiration
    'mod16a2':
    tr_layers.tr('MOD16A2'),

    # Precipitation
    'chirps':
    tr_layers.tr('CHIRPS'),
    'gpcc_v7':
    tr_layers.tr('GPCC V7 (Global Precipitation Climatology Centre)'),
    'gpcp_v231':
    tr_layers.
    tr('GPCP v2.3 1 month (Global Precipitation Climatology Project)'),
    'persiann_cdr':
    tr_layers.tr('PERSIANN-CDR'),

    # Soil Moisture
    'era_1':
    tr_layers.tr('ERA I'),
    'merra_2':
    tr_layers.tr('MERRA 2'),

    # NDVI
    'mod13q1_annual':
    tr_layers.tr('MODIS (MOD13Q1, annual)'),
    'avhrr_gimms3_annual':
    tr_layers.tr('AVHRR (GIMMS3g.v1, annual)'),
    'mod13q1_16day':
    tr_layers.tr('MODIS (MOD13Q1, 16 day)'),

    # Soil Type
    'soil_grids_250_wrb':
    tr_layers.tr('Soil Grids 250'),
    'usda_soil_type':
    tr_layers.tr('USDA Soil Type'),
...
def _get_cutoff(
    ...
    if len(percentiles) != 1 and len(percentiles) != 2:
        raise ValueError(
            "Percentiles must have length 1 or 2. Percentiles that were passed: {}"
            .format(percentiles)
        )
    ...
    if md.size == 0:
        ...
        if cutoffs.size == 2:
            ...
            raise ValueError(
                "Stretch calculation returned cutoffs array of size {} ({})".
                format(cutoffs.size, cutoffs)
            )
...
def _create_categorical_with_dynamic_ramp_color_ramp(
    ...
    result.append(
        QgsColorRampShader.ColorRampItem(
            ...
            tr_style_text(
                style_config['ramp']['ramp min']['label'], band_info
            )
        )
    )
    result.append(
        QgsColorRampShader.ColorRampItem(
            ...
            tr_style_text(
                style_config['ramp']['ramp max']['label'], band_info
            )
        )
    )
...
def _create_zero_centered_stretch_color_ramp(
    ...
    result = [
        QgsColorRampShader.ColorRampItem(
            -cutoff, QColor(style_config['ramp']['min']['color']),
            '{}'.format(-cutoff)
        ),
        QgsColorRampShader.ColorRampItem(
        ...
        QgsColorRampShader.ColorRampItem(
            cutoff, QColor(style_config['ramp']['max']['color']),
            '{}'.format(cutoff)
        ),
        QgsColorRampShader.ColorRampItem(
...
def _create_min_zero_stretch_color_ramp(
    ...
    if 'mid' in style_config['ramp']:
        result.append(
            QgsColorRampShader.ColorRampItem(
                cutoff / 2, QColor(style_config['ramp']['mid']['color']),
                str(cutoff / 2)
            )
        )
    result.append(
...
def add_layer(
    ...
    try:
        ...
        QtWidgets.QMessageBox.information(
            None, tr_layers.tr("Information"),
            tr_layers.tr(
                u'Trends.Earth does not have a style assigned for "{}" (band {} '
                u'in {}). To use this layer, manually add it to your map.'.
                format(band_info['name'], band_number, layer_path)
            )
        )
        log(
            u'No style found for "{}" in {}'.format(
