...
class ldn_total_by_transTests(unittest.TestCase):
    def test_trans(self):
        ...
        self.assertTrue(
            all(trans == np.asarray((101, 102, 103, 104, 105), dtype=np.int16))
        )
    ...
    def test_totals(self):
        ...
        self.assertTrue(
            all(totals == np.asarray((11, 24, 39, 56, 75), dtype=np.float32))
        )
...
class ldn_total_by_trans_mergeTests(unittest.TestCase):
    def test_merge_trans_same(self):
        ...
        self.assertTrue(
            all(totals == np.asarray((33, 72, 117, 168, 225), dtype=np.float32))
        )
    ...
    def test_merge_trans_different(self):
        ...
        self.assertTrue(
            all(
                trans
                == np.asarray(
                    (101, 102, 103, 104, 105, 202, 204, 206, 208, 210), dtype=np.int16
                )
            )
        )
        self.assertTrue(
            all(
                totals
                == np.asarray(
                    (11, 24, 39, 56, 75, 22, 48, 78, 112, 150), dtype=np.float32
                )
            )
        )
