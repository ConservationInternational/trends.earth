...
def urban(isi_thr, ntl_thr, wat_thr, cap_ope, pct_suburban, pct_urban, crs, 
    ...
    for geojson in geojsons:
        ...
        this_out = TEImage(rast_export,
            [BandInfo("Urban", activated=False, metadata={'year': 2000}),
             BandInfo("Urban", activated=False, metadata={'year': 2005}),
             BandInfo("Urban", activated=False, metadata={'year': 2010}),
             BandInfo("Urban", activated=False, metadata={'year': 2015}),
