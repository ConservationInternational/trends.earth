...
class CalculateLDNSummary(unittest.TestCase):
    def setUp(self):
    ...
    def test_job_submission(self):
        ldn_summary_script_name = "sdg-15-3-1-summary"

        script = [
            s for s in KNOWN_SCRIPTS.values() if s.name == ldn_summary_script_name
        ][0]
