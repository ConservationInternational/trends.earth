...
class CalculateLocalSoc(unittest.TestCase):
    def setUp(self):
    ...
    def test_job_submission(self):
        local_land_cover_script_name = "local-soil-organic-carbon"

        script = [
            s for s in KNOWN_SCRIPTS.values() if s.name == local_land_cover_script_name
        ][0]
